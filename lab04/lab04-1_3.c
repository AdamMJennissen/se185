...
-----------------------------------------------------------------------------*/
#include <time.h>
#include <stdio.h>//added the standard input and output library
#include <stdlib.h>//added the standard library in order to use rand function

/*----------------------------------------------------------------------------
-	                            Prototypes                                   -
-----------------------------------------------------------------------------*/
void hoo();
void print_face(int selection);//added prototype for the function
